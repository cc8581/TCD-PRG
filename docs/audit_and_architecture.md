...
| Global grasp set | official M2T2 architecture pattern | same shared decoder + neutral global query bank | task-free scene points | K complete poses, openings, object assignments and scene qualities | object-balanced open-world Hungarian loss from native PICK_REMOVE outcomes | PICK_REMOVE candidates |
